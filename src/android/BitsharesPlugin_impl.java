...
public class BitsharesPlugin_impl {

  private static final String PROD_PREFIX = "BTS";
  private static final String TEST_PREFIX = "DVS";

  public InputStream BIP32EnglishFile = null;

  public JSONObject createMasterKey(Boolean test) throws JSONException {
  ...
  public JSONObject extractDataFromKey(Boolean test, String grandParent, String parent, String key) throws UnsupportedEncodingException, JSONException {
  ...
  public JSONObject derivePrivate(Boolean test, String grandParent, String parent, String key, int deriv) throws UnsupportedEncodingException, JSONException {
  ...
  public JSONObject compactSignatureForHash(Boolean test, String Wif, String hash) throws UnsupportedEncodingException, AddressFormatException, JSONException {
  ...
  public JSONObject compactSignatureForMessage(Boolean test, String Wif, String msg) throws UnsupportedEncodingException, AddressFormatException, JSONException {
  ...
  public JSONObject recoverPubkey(Boolean test, String signature, String msg) throws UnsupportedEncodingException, AddressFormatException, JSONException {
  ...
  public JSONObject isValidKey(Boolean test, String grandParent, String parent, String key) throws JSONException {
    DeterministicKey dk = DeterministicKey.deserializeB58(fromB58(grandParent, parent), key);
    JSONObject result = new JSONObject();
  ...
  public JSONObject isValidWif(Boolean test, String wif) throws JSONException, AddressFormatException {
    ECKey key = new DumpedPrivateKey(null, wif).getKey();
    JSONObject result = new JSONObject();
    result.put("is_valid", "true");
    return result;
  ...
  public JSONObject btsWifToAddress(Boolean test, String wif) throws JSONException, AddressFormatException {
    ECKey key = new DumpedPrivateKey(null, wif).getKey();
  ...
  public JSONObject btsPubToAddress(Boolean test, String pubkey) throws JSONException, Exception {
  ...
  public JSONObject btcIsValidAddress(Boolean test, String addy) throws JSONException, Exception {
  ...
  public JSONObject btsIsValidAddress(Boolean test, String addy) throws JSONException, Exception {
  ...
  public JSONObject btsIsValidPubkey(Boolean test, String pubkey) throws JSONException, Exception {
  ...
  public JSONObject encryptString(Boolean test, String data, String password) throws JSONException, IOException {
  ...
  public JSONObject decryptString(Boolean test, String data, String password) throws JSONException, IOException {
  ...
  public JSONObject requestSignature(String key, String nonce, String url, String body) throws JSONException, IOException {
    JSONObject result = new JSONObject();
  ...
  public JSONObject decryptMemo( Boolean test, String oneTimeKey, String encryptedMemo, String privKey) throws JSONException, IOException, Exception, InvalidCipherTextException {
    JSONObject result = new JSONObject();
  ...
  public JSONObject createMemo(Boolean test, String fromPubkey, String destPubkey, String message, String oneTimePriv) throws JSONException, IOException, Exception, InvalidCipherTextException {
    JSONObject result = new JSONObject();
    //dest = (dd, Qd)
    //tmp  = (dp, Qp)
    //(xk, yk) = dp * Qd
  ...
  private void initMnemonicInstance() throws IOException {
    if ( MnemonicCode.INSTANCE == null ) {
      ...
      MnemonicCode.INSTANCE = new MnemonicCode(BIP32EnglishFile, BIP39_ENGLISH_SHA256);
    }
  }

  public JSONObject createMnemonic( int entropy ) throws JSONException, IOException, Exception {
  ...
  public JSONObject mnemonicToMasterKey( String words ) throws JSONException, IOException, Exception {
    JSONObject result = new JSONObject();
  ...
  public JSONObject sha256( String data ) throws JSONException, IOException, Exception {
    JSONObject result = new JSONObject();
    result.put("sha256", new String(Hex.encode(sha256(data.getBytes())), "UTF-8"));
    return result;
  }

  public JSONObject randomInteger()  throws JSONException, IOException, Exception {
    JSONObject result = new JSONObject();
  ...
  public JSONObject randomData(int length)  throws JSONException, IOException, Exception {
    JSONObject result = new JSONObject();
  ...
  public JSONObject skip32( int value, String skip32key, Boolean encrypt )  throws JSONException, IOException, Exception {
    JSONObject result = new JSONObject();
  ...
  public JSONObject pbkdf2(String password, String salt, int c, int dkLen)  throws JSONException, IOException, Exception {
    JSONObject result = new JSONObject();
